...
1. Rename htaccess to .htaccess (Github does not allow to upload .htaccess)
2. Open and edit config file at king-config.php with your database, user and pass
3. Go to your website https address.
4. Run installer and create admin account.
