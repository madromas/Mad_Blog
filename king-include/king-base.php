...
*/
	...
	define('QA_VERSION', '5.2'); // also used as suffix for .js and .css requests
	define('QA_BUILD_DATE', '2019-03-14');
...
*/
	...
	//	Possible URL schemes for KINGMEDIA and the string used for url scheme testing
		...
		define('QA_URL_FORMAT_INDEX', 0);  // https://...../index.php/123/why-is-the-sky-blue
		define('QA_URL_FORMAT_NEAT', 1);   // https://...../123/why-is-the-sky-blue [requires .htaccess]
		define('QA_URL_FORMAT_PARAM', 3);  // https://...../?qa=123/why-is-the-sky-blue
		define('QA_URL_FORMAT_PARAMS', 4); // https://...../?qa=123&qa_1=why-is-the-sky-blue
		define('QA_URL_FORMAT_SAFEST', 5); // https://...../index.php?qa=123&qa_1=why-is-the-sky-blue
...
*/
	{
		...
		// inspired by: https://dangerousprototypes.com/docs/PhpBB3_MOD:_Replacement_mobile_browser_detection_for_mobile_themes
