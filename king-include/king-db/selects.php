...
*/
	{
		...
		$selectspec=array(
			'columns' => array(
				...
				'^posts.flagcount', '^posts.title', '^posts.postformat', '^posts.tags', 'created' => 'UNIX_TIMESTAMP(^posts.created)', '^posts.name',
...
*/
	{
		...
		if (QA_FINAL_EXTERNAL_USERS)
			...
			return array(
				'columns' => array('^users.userid', 'handle', 'points', 'level', 'flags', '^users.email', 'avatarblobid' => 'BINARY avatarblobid', 'avatarwidth', 'avatarheight'),
