...
<html>
	<head>
		...
		<style type="text/css">
			input { font-size:16px; font-family:Verdana, Arial, Helvetica, sans-serif;border: 2px solid #dee1e3;color: #667686;font-weight: bold;padding: 9px;border-radius: 5px;-webkit-border-radius: 5px;}
			body {font-size:0; font-family:Verdana, Arial, Helvetica, sans-serif;text-align:center; width:640px; margin:64px auto; background-color:#ededed;color: #667686;}
			table {margin: 16px auto;font-size:16px;}
			.install-body {font-size:16px;background-color:#fff; padding:10px; border-radius:6px;}
			.install-button {background-color: #00bff3;border: 1px solid #00bff3;color: #fff; padding:12px 16px; border-radius:6px; cursor:pointer;}
		</style>
	</head>
	<body>
<?php
