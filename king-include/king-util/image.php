		...
		if (function_exists('memory_get_usage')) {
			...
			if ($gotbytes>0) { // otherwise we clearly don't know our limit
				...
				if (is_array($imagesize)) { // if image can't be parsed, don't worry about anything else
					...
					$channels=isset($imagesize['channels']) ? $imagesize['channels'] : 3; // for more info: https://gynvael.coldwind.pl/?id=223
...
/*
	Given $imagedata containing JPEG/GIF/WEBP/PNG data, constrain it proportionally to fit in $maxwidth x $maxheight.
