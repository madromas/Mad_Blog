...
*/	
	...
	return array(
		...
		'a_followed_body' => "Your Comment on ^site_title has a new related Media by ^q_handle:\n\n^open^q_title^close\n\nYour Comment was:\n\n^open^a_content^close\n\nClick below to Comment the new Media:\n\n^url\n\nThank you,\n\n^site_title",
		'a_followed_subject' => 'Your ^site_title Comment has a related Media',
		...
		'q_answered_body' => "Your Media on ^site_title has been Commented by ^a_handle:\n\n^open^a_content^close\n\nYour Media was:\n\n^open^q_title^close\n\nIf you like this Comment, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
		'q_answered_subject' => 'Your ^site_title Media was Commented',

		'q_commented_body' => "Your Media on ^site_title has a new comment by ^c_handle:\n\n^open^c_content^close\n\nYour Media was:\n\n^open^c_context^close\n\nYou may respond by adding your own comment:\n\n^url\n\nThank you,\n\n^site_title",
		'q_commented_subject' => 'Your ^site_title Media has a new comment',

		'q_posted_body' => "A new Media has been submited by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the Media:\n\n^url\n\nThank you,\n\n^site_title",
		'q_posted_subject' => '^site_title has a new Media',
