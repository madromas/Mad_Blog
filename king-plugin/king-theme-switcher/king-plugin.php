...
/*			  
		Plugin Name:King Theme Switcher
		Plugin URI: 
		Plugin Update Check URI: 
		Plugin Description: King Theme Switcher
		Plugin Version: 1.0b
		Plugin Date: 2014-06-11
...
*/					  
		...
		qa_register_plugin_module('module', 'king-theme-admin.php', 'qa_theme_admin', 'Theme Admin');

//		qa_register_plugin_module('process', 'king-theme-process.php', 'qa_theme_process', 'Theme Process');
		
		qa_register_plugin_layer('king-theme-layer.php', 'Theme Layer');
		
		if(function_exists('qa_register_plugin_overrides')) { // 1.5
		
			qa_register_plugin_overrides('king-theme-overrides.php');
